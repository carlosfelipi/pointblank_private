                                        ...
                                        <tr>
                                            <td align="center" valign="top" style="padding-bottom: 20px;"
                                                ...
                                                <a href="#" target="_blank" style="text-decoration:none;">
                                                    <img src="http://weekly.grapestheme.com/notify/img/hero-img/blue/heroFill/user-reset-password.png"
                                        ...
                                        <tr>
                                            <td align="center" valign="top"
                                                ...
                                                <h4 class="text"
                                                    ...
                                                    Siga os passos abaixo para definir sua nova senha.
                                                </h4>
                                            </td>
                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td align="center" valign="top"
                                                                ...
                                                                <p class="text"
                                                                    ...
                                                                    você tem 24 horas para escolher sua senha. Depois
                                                                    disso,
                                                                    você terá que pedir um novo.
                                                                </p>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td align="center" valign="top"
                                                                ...
                                                                <p class="text"
                                                                    style="color:#666666; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:14px; font-weight:400; font-style:normal; letter-spacing:normal; line-height:22px; text-transform:none; text-align:center; padding:0; margin:0">
                                                                    Ou usando este Link: <a href="{{ route('forgotPasswordStepTwoPage') }}?token={{ $player->remember_token }}"
                                                                        target="_blank"
                                                                        style="color:#3F4CA4">{{ route('forgotPasswordStepTwoPage') }}?token={{ $player->remember_token }}</a>
                                                                </p>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            <td align="center" class="ctaButton"
                                                                                style="background-color: #4191da; padding: 12px 35px; border-radius: 20px;">
                                                                                <!-- Button Link // -->
                                                                                <a class="text"
                                                                                    href="{{ route('forgotPasswordStepTwoPage') }}?token={{ $player->remember_token }}"
                                                                                    target="_blank"
