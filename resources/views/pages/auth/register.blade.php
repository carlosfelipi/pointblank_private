    ...
    <form class="dev_check_enter" wire:submit.prevent="registerProccess">
        <ul>
            <li>
                ...
                @error('login')
                    <p class="wrong" id="notice_login">{{ $message }}</p>
                @enderror
            </li>
            ...
            <li class="in_btn">
                ...
                @error('password')
                    <p class="wrong" id="notice_password">{{ $message }}</p>
                @enderror
            ...
            <li class="in_btn">
                ...
                @error('confirm')
                    <p class="wrong" id="notice_confirm">{{ $message }}</p>
                @enderror
            ...
            <li>
                ...
                @error('email')
                    <p class="wrong" id="notice_email">{{ $message }}</p>
                @enderror
            </li>
            ...
            <li class="term">
                ...
                @error('term')
                    <p class="wrong" id="notice_term">{{ $message }}</p>
                @enderror
            </li>
