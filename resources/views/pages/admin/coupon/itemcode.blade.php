                            ...
                            <tbody>
                                ...
                                @forelse ($pins as $pin)
                                    <tr>
                                        ...
                                        <td>
                                            @php
                                                if ($pin->item_count < '86400') {
                                                    if ($pin->item_count == '1') {
                                                        echo number_format($pin->item_count) . ' Unidade';
                                                    } else {
                                                        echo number_format($pin->item_count) . ' Unidades';
                                                    }
                                                } else {
                                                    if ($pin->item_count / 24 / 60 / 60 == '1') {
                                                        echo $pin->item_count / 24 / 60 / 60 . ' Dia';
                                                    } else {
                                                        echo $pin->item_count / 24 / 60 / 60 . ' Dias';
                                                    }
                                                }
                                            @endphp
                                        </td>
