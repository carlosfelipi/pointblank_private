                ...
                <div class="card card-absolute">
                    ...
                    <div class="card-body">
                        <div class="form theme-form">
                            <form class="needs-validation" action="{{ route('newsEditProcess', ['id' => $item->id]) }}"
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control"
                                                value="{{ date('Y-m-d', strtotime($item->expired_at)) }}" type="date"
                                                data-language="pt" name="end" required />
                                        </div>
                                    </div>
                                </div>
                                <br>
