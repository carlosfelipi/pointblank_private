<x-layouts.admin.app title="Editar Notícia">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <div class="card card-absolute">
                    <div class="card-header bg-primary">
                        <h5 class="text-white">Editar Notícia</h5>
                    </div>
                    <div class="card-body">
                        <div class="form theme-form">
                            <form class="needs-validation" action="{{ route('blogProccessCreate') }}" method="post"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input class="form-control" value="{{ $item->title }}" name="title"
                                            id="validationCustom01" type="text" placeholder="Digite algo..."
                                            required>
                                    </div>
                                    <div class="col">
                                        <div class="form-group">
                                            <label>Subtítulo</label>
                                            <input class="form-control" value="{{ $item->description }}"
                                                id="validationCustom02" name="description" type="text"
                                                placeholder="Subtítulo da notícia" required>
                                        </div>
                                    </div>
                                </div>
                                <br>
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" value="{{ date('Y-m-d', strtotime($item->expired_at)) }}" type="date" data-language="pt" name="end"
                                                required />
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <textarea id="text-box" class="form-control" type="text" name="post" id="validationCustom05" required>
                                                {{ $item->post }}
                                            </textarea>
                                        </div>
                                    </div>
