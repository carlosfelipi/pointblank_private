<x-layouts.admin.app title="Evento Xmas">
  <x-slot:css>
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-sm-12">
        <div class="card card-absolute">
          <div class="card-header bg-primary">
            <h5 class="text-white">Adicionar Evento Xmas</h5>
          </div>
          <div class="card-body">
            <div class="form theme-form">
              <form class="needs-validation" action="{{ route('xmasAddProcess') }}" method="post" id="formQuest"
              novalidate="">
              @csrf
              <div class="row">
                <div class="col-md-6">
      ...
      <div class="col-sm-12">
        <div class="card card-absolute">
          <div class="card-header bg-primary">
            <h5 class="text-white">Evento Xmas Criados</h5>
          </div>
          <br> <br>
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title deleteModal">Remover Evento Xmas</h5>
  ...
  <x-slot:js>
    <script>
     ...
     const url = "{{ route('xmasDeleteProcess', ['id' => '$__ID']) }}";
